...
/**
 * Build a virtual "Pinned" section out of the user's pinned employee urlIds.
...
export const buildPinnedEmployeeSection = (
  ...
  // Keep the pinning order (as in pinnedUrlIds), not alphabetical.
...
/**
 * Wrap all (non-pinned) employees into a single "All employees" section.
 */
