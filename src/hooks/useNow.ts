 ...
 * milliseconds. Defaults to a 30-second tick — a step small enough to
 * visually advance the progress of an ongoing lesson and move lessons that
 * just ended into the "past" state.
 *
