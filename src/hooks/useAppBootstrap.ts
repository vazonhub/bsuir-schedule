...
export const useAppBootstrap = () => {
  ...
  useEffect(() => {
    ...
    void initAds();
    // Diary: wait for store rehydration, subscribe to changes,
    // run the first pull+merge from the cloud. It does not need the schedule —
    // no need to tie it to prefetchPinned.
