...
export const NetworkDataScreen = () => {
  ...
  // The Google account is temporarily removed from the Android UI; the auth, sync
  // and config-plugin code stays in the repository. To bring it back, set the flag to true.
