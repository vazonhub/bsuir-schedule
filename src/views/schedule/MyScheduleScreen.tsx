...
/**
 * "My schedule" — the app's main screen.
 *
 * - If a `defaultGroup` is selected → show its schedule.
 * - If a `defaultEmployee` is selected → show the teacher's schedule.
 * - If nothing is selected → prompt the user to pick.
 */
