...
/**
 * Two-line day header: large day-of-week name on top, date and status
 * ("Today" / "Tomorrow") below, cycle week number as a chip on the right.
 * Rendered on the screen background (`Palette.background`), sticky disabled —
 * the "current day" is shown by `FloatingTopBar`.
 */
