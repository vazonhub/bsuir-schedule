export const ru = {
  ...
  diary: {
    ...
    streakTitle: 'Огонёк',
    streakCurrent: 'Сейчас: {{n}} дн.',
    streakLongest: 'Рекорд: {{n}} дн.',
    streakRules:
      'Отмечай хотя бы 1 задание в будни, чтобы продолжать. Выходные не в счёт — не ломают и не наращивают.',
    streakA11y: 'Огонёк, {{n}} дней подряд',
