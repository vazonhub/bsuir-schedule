export const ru = {
  ...
  onboarding: {
    ...
    welcomeBody: 'Здесь ты ведёшь задания по предметам своей группы. Покажем за минуту, что тут можно делать.',
    streakTitle: 'Огонёк',
    streakBody: 'Выполняй задания и заходи в учебные дни — серия растёт. Пропустишь — огонёк начнёт гаснуть.',
    plannerTitle: 'Планер',
    ...
    subjectCardBody: 'Каждая карточка — предмет из расписания. Счётчики показывают, сколько заданий осталось по типам пар.',
    ...
    completeTaskBody: 'Тапай по клетке задания, когда сделал его. Выполненные задания растят огонёк.',
    hideSubjectTitle: 'Скрыть предмет',
    hideSubjectBody: 'Удерживай карточку, чтобы скрыть предмет, сбросить прогресс или изменить количество.',
    next: 'Далее',
    skip: 'Пропустить',
    done: 'Готово',
    stepProgress: 'Шаг {{current}} из {{total}}',
    replay: 'Пройти обучение заново',
  },
