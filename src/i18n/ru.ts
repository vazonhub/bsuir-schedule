export const ru = {
  ...
  diary: {
    ...
    notePlaceholder: 'Заметка к заданию. Поддерживается Markdown, ссылки, фото и файлы.',
    noteEmpty: 'Заметки пока нет. Нажмите «Изменить», чтобы добавить.',
    noteAttachImage: 'Фото',
    noteAttachFile: 'Файл',
