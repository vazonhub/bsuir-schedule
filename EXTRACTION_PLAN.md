...
- **App Group** — общая для приложения и виджета entitlement. Плагин должен генерировать _и_ main app entitlement (`com.apple.security.application-groups`) _и_ widget target entitlement.
